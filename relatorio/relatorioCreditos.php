...
$query = "SELECT COUNT(*) AS total, p.post_date AS dt_cadastro
          ...
          AND p.post_type IN ('msg_enviada', 'msg_respondida', 'msg_recebida')
...
$hc->setTitulo(utf8_decode('Quantidade Créditos Utilizados'));
$hc->setTituloLateral('Qtd.');

foreach ($resultado as $res) {	
	$hc->addCategoria(FormataData($res->dt_cadastro));
	$hc->addValores("Créditos", $res->total);	
}
...
<section class="content-header">
  ...
  <div>
    <label><i>Este relatório pode sofrer alterações, pois o provedor não oferece integração.</i></label>
  </div>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          <form name="form" id="form" action="<?php home_url(); ?>?ctr=relatorio&mt=relatorioCreditos" method="post" >
            <div class="col-md-3">
